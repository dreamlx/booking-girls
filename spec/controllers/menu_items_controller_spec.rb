  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved menu_item as @menu_item" do
        ...
        post :create, {:menu_item => { "title" => "invalid value" }}, valid_session
        assigns(:menu_item).should be_a_new(MenuItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested menu_item" do
        ...
        MenuItem.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => menu_item.to_param, :menu_item => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the menu_item as @menu_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        MenuItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => menu_item.to_param, :menu_item => { "title" => "invalid value" }}, valid_session
        assigns(:menu_item).should eq(menu_item)
      end
